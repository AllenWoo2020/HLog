...
public class Hao extends FrameLayout implements Thread.UncaughtExceptionHandler, Application.ActivityLifecycleCallbacks {
    ...
    private Hao(final Context context) {
        super(context);
        mContext = context;
        ...
        mLogContainer.setBackgroundColor(Color.argb(0x35, 0X00, 0x00, 0x00));
        int widthPixels = context.getResources().getDisplayMetrics().widthPixels;
        int heightPixels = context.getResources().getDisplayMetrics().heightPixels;
        LayoutParams layoutParams = new LayoutParams((int)(widthPixels / 1.3), (int)(heightPixels / 2.2), Gravity.CENTER);
        mLogContainer.setLayoutParams(layoutParams);
        mLogContainer.setVisibility(GONE);
        //小窗口标题
        mTvTitle = new TextView(context);
        mTvTitle.setTextSize(v * 1.5f);
        mTvTitle.setText("江湖人称昊哥");
        mTvTitle.setTextColor(Color.WHITE);
        mTvTitle.setBackgroundColor(Color.argb(0x56, 0X00, 0x00, 0x00));
...
//                        ToastUtils.toast(textView.getText().toString());
//                    }
//                });
                return textView;
            }
        ...
        mLvLog.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                mes=((TextView)view).getText().toString();
                //ToastUtils.toast(((TextView)(mLogAdapter.getView(position,view,parent))).getText().toString());
                AlertDialog.Builder builder = new AlertDialog.Builder(mCurrentActivity);
                String message = mFilterList.get(position);
                //mes = mFilterList.get(position);
                ...
                builder.setNeutralButton("复制", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        String info=mes.substring(mes.indexOf("^:\n")).replace("^:\n","");
                        copy2clipboard1(mCurrentActivity,info+"");
                    }
                });
...
//        handler.postDelayed(mRunnable, 10000);
    ...
    public static void copy2clipboard1(Context context, String text) {
     ...
     * @param application
     */
    public static void init(Application application,boolean kaiqi) {
        debuggable=kaiqi;
        if (debuggable && me == null) {
            synchronized (Hao.class) {
                if (me == null) {
                    me = new Hao(application.getApplicationContext());
    ...
    private void print(int type, String tag, String msg) {
        ...
        String str = "[" + getTime() + "]" + getLevel(type) + "/" + tag + ":"+"<br/>" + msg;
    ...
    private void addText(int type, String text) {
        String[] level = new String[]{"#FFFFFF", "", "#BA55D3", "#2FB1FE", "#00ff00", "#EFC429", "#FF0000"};
    ...
    public void showFloatView() {
        WindowManager windowManager = (WindowManager) mCurrentActivity.getSystemService(WINDOW_SERVICE);
        ...
        params.x = 0;
        params.y = 0;
        windowManager.addView(initDialogView(), params);
    }
    ...
    private View initDialogView() {
        ...
        //开关
        View contentView = LayoutInflater.from(mCurrentActivity).inflate(R.layout.swi, null);
        Switch mSwitch = contentView.findViewById(R.id.mZSwitch);
        Switch mSwitch1 = contentView.findViewById(R.id.mZSwitch1);
        if(huadong){
    ...
    private boolean handleException(final Thread t, final Throwable e) {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                Looper.prepare();
                Toast.makeText(mCurrentActivity, "APP 崩溃", Toast.LENGTH_LONG).show();
                AlertDialog.Builder builder = new AlertDialog.Builder(mCurrentActivity);
